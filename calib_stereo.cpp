...
//   left_dir = opendir (leftimg_dir);

//   DIR *right_dir;
//   struct dirent *right_ent;
//   right_dir = opendir (rightimg_dir);

//   for (int i = 1; i <= num_imgs; i++) {
//     left_ent = readdir(left_dir);
//     std::cout << "Found file " << left_ent->d_name << std::endl;
//     std::string left_dname(left_ent->d_name);
//     if (left_dname=="frames.txt") {
//       std::cout << "Discarding file..." << '\n';
//       continue;
//     }
//     std::string frame = left_dname.substr(4, 4);
//     std::string right_filename = "right"+frame;
//     std::string left_filename = "left"+frame;
    
//     char left_img[100], right_img[100];
//     sprintf(left_img, "%s%s.%s", leftimg_dir, left_filename.c_str(), extension);
//     sprintf(right_img, "%s%s.%s", rightimg_dir, right_filename.c_str(), extension);
